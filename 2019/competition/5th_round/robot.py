...
#        self.start_cameras()
    ...
    def robotPeriodic(self):
        switchValue = self.compressor.getPressureSwitchValue()
        self.compressor.setClosedLoopControl(switchValue)
    ...
    def teleopPeriodic(self):
        ...
        if self.ds.getStickButton(STICK, BEAM_UP_BTN) or not self.retracted_lift:
            self.beam_motor.set(BEAM_SPEED)
        elif self.ds.getStickButton(STICK, BEAM_DOWN_BTN) and not self.retracted_lift:
            self.beam_motor.set(-BEAM_SPEED)
        else:
