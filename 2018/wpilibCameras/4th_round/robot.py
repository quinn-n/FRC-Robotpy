...
extendScissorLiftVerticalChannel = 3
retractScissorLiftVerticalChannel = 2
extendScissorLiftHorizontalChannel = 4
retractScissorLiftHorizontalChannel = 1
#settings
intakeSpeed = .4
class robot(wpilib.IterativeRobot):
    ...
    def extendLift(self,delay=0):
        self.extendScissorLiftVertical.set(True)
        self.retractScissorLiftHorizontal.set(True)
        self.retractScissorLiftVertical.set(False)
        self.extendScissorLiftHorizontal.set(False)
        if delay != 0:
            time.sleep(delay)
            self.extendScissorLiftVertical.set(False)
            self.retractScissorLiftHorizontal.set(False)
    def retractLift(self,delay=0):
        self.extendScissorLiftVertical.set(False)
        self.retractScissorLiftHorizontal.set(False)
        self.retractScissorLiftVertical.set(True)
        self.extendScissorLiftHorizontal.set(True)
        if delay != 0:
            time.sleep(delay)
            self.retractScissorLiftVertical.set(False)
            self.extendScissorLiftHorizontal.set(False)
...
#        self.rightIntake.setInverted(True)
        #solenoids
        self.extendScissorLiftVertical = wpilib.Solenoid(extendScissorLiftVerticalChannel)
        self.retractScissorLiftVertical = wpilib.Solenoid(retractScissorLiftVerticalChannel)
        self.extendScissorLiftHorizontal = wpilib.Solenoid(extendScissorLiftHorizontalChannel)
        self.retractScissorLiftHorizontal = wpilib.Solenoid(retractScissorLiftHorizontalChannel)
