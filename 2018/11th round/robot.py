...
camera0FPS = 30
camera1FPS = 30
cameraName0 = "Left Camera"
cameraName1 = "Centre Camera"
class robot(wpilib.IterativeRobot):
    ...
    def robotInit(self):
        ...
        self.camera0 = self.cameraServer.startAutomaticCapture(dev=0,name=cameraName0)
        self.camera1 = self.cameraServer.startAutomaticCapture(dev=1,name=cameraName1)
        self.camera0.setFPS(camera0FPS)
        self.camera1.setFPS(camera1FPS)
    ...
    def teleopPeriodic(self):
        ...
        turningSpeed *=turningSensitivity #multiplier for sensitivity
